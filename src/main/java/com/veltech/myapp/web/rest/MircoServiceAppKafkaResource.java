...
@RestController
@RequestMapping("/api/mirco-service-app-kafka")
public class MircoServiceAppKafkaResource {

    private final Logger log = LoggerFactory.getLogger(MircoServiceAppKafkaResource.class);
    ...
    public MircoServiceAppKafkaResource(@Qualifier(KafkaSseProducer.CHANNELNAME) MessageChannel output) {
        this.output = output;
    }
